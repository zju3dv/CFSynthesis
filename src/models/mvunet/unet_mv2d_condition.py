...
class UNetMV2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        class_embed_type: Optional[str] = 'camera',
    ...
    def forward(
        ...
        # 2. pre-process
        sample = self.conv_in(sample) # no change of dimension
    ...
    def from_pretrained_2d(
            ...
            num_views: int, camera_embedding_type: str='e_de_da_sincos', sample_size: int=512,
        ...
        config['class_embed_type'] = 'camera'
