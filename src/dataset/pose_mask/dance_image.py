...
class HumanDanceDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pose_mask = Image.fromarray(self.pil2binary_fg(tgt_pose_pil))
        ...
        tgt_pose_mask = self.augmentation(pose_mask, self.cond_transform, state)
        ...
        ref_img_vae=torch.concat((ref_img_vae, self.normalization(ref_img_mask)),dim=0)
        tgt_pose_img = torch.concat((tgt_pose_img, self.normalization(tgt_pose_mask)),dim=0)
